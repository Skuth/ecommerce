...
class User extends Model
{
	...
	public static function getForgot($email)
	{
		...
		else
		{
			...
			else
			{
				...
				$link = "http://www.skuthecommerce.com.br/admin/forgot/reset?code=$code";

				$mailer = new Mailer($data["desemail"], $data["desperson"], "Redefinir Senha da Skuth Store", "forgot",
				array(
					"name"=>$data["desperson"],
					"link"=>$link
				));
	...
	public static function setForgotUsed($idrecovery)
	{
		...
		$sql->query("UPDATE tb_userspasswordsrecoveries SET dtrecovery = NOW() WHERE idrecovere = :idrecovery",
		array(
			":idrecovery"=>$idrecovery
		));
